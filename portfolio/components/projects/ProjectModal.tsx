              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 bg-secondary/10 text-text rounded-full text-sm"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                {project.githubLink && (
                  <Link
                    ...
                    className="inline-flex items-center px-5 py-2 bg-accent text-text font-medium rounded-full transition-colors hover:bg-accent/80"
                  >
                    <svg
                ...
                {project.liveLink && (
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center px-5 py-2 bg-primary text-text font-medium rounded-full transition-colors hover:bg-primary/80"
                  >
                    <svg
                      className="w-5 h-5 mr-2"
                      fill="none"
