...
export default function SocialBar() {
  return (
    <div className="flex flex-col sm:flex-row border-t border-b border-accent w-full items-center justify-between py-4 sm:h-24 gap-4 sm:gap-12 px-4 sm:px-12">
      <motion.div
